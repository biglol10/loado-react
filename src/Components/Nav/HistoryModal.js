      ...
      <Modal.Content>
        <Grid>
          ...
          <Grid.Row style={{padding:'10px 0px'}}>
            ...
            <Grid.Column width={14}>
            1. 9월10일 업데이트 후 첫 로그인 시 화면에 아무것도 안 뜨던 현상 수정,
          컨탠츠에 마우스 올리면 행의 색갈이 바뀌도록 수정
          <br/>
          2. 카던, 가디언, 에포나에 숫자로 선택할 필요없이 체크로 선택하여 저장하기
          가능토록 수정
            </Grid.Column>
          </Grid.Row>
          <Grid.Row style={{padding:'10px 0px'}}>
            ...
            <br/>
            2. 깜빡거림으로 사용자가 업데이트 내용을 확인할 수 있도록 추가 및 작업
          내역 확인 후 깜빡거림 멈추는 기능 추가
            </Grid.Column>
          </Grid.Row>
          <Grid.Row style={{padding:'10px 0px'}}>
            <Grid.Column className="updateItemDate" width={2}>
            ...
            <Grid.Column width={14}>
            어플리케이션 업그레이드 비용 지불 및 다음날부터 내부에서 06시 휴식게이지 반영되도록 수정 (잘 안될 수도 있음), 안되면 개인휴식게이지반영 적용 요청
            </Grid.Column>
          </Grid.Row>
          <Grid.Row style={{padding:'10px 0px'}}>
            <Grid.Column className="updateItemDate" width={2}>
